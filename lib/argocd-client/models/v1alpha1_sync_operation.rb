...
module ArgoCD
  ...
  class V1alpha1SyncOperation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'syncStrategy')
        self.sync_strategy = attributes[:'syncStrategy']
      end
    end
    ...
    def hash
      [dry_run, manifests, prune, resources, revision, revisions, source, sources, sync_options, sync_strategy].hash
    end
