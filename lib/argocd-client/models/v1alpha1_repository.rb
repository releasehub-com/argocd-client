...
module ArgoCD
  class V1alpha1Repository
    attr_accessor :connection_state

    # EnableLFS specifies whether git-lfs support should be enabled for this repo. Only valid for Git repositories.
    attr_accessor :enable_lfs
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connectionState')
        self.connection_state = attributes[:'connectionState']
      end

      if attributes.has_key?(:'enableLfs')
        self.enable_lfs = attributes[:'enableLfs']
      end
      ...
      if attributes.has_key?(:'inheritedCreds')
        self.inherited_creds = attributes[:'inheritedCreds']
      end
      ...
      if attributes.has_key?(:'insecureIgnoreHostKey')
        self.insecure_ignore_host_key = attributes[:'insecureIgnoreHostKey']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inherited_creds == o.inherited_creds &&
          insecure == o.insecure &&
    ...
    def hash
      [connection_state, enable_lfs, enable_oci, force_http_basic_auth, gcp_service_account_key, github_app_enterprise_base_url, github_app_id, github_app_installation_id, github_app_private_key, inherited_creds, insecure, insecure_ignore_host_key, name, password, project, proxy, repo, ssh_private_key, tls_client_cert_data, tls_client_cert_key, type, username].hash
    end
