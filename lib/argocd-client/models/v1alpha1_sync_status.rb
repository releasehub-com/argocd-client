...
module ArgoCD
  class V1alpha1SyncStatus
    attr_accessor :compared_to
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'comparedTo')
        self.compared_to = attributes[:'comparedTo']
      end
    ...
    def hash
      [compared_to, revision, revisions, status].hash
    end
