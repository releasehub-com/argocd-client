...
module ArgoCD
  class RepositoryParameterAnnouncement
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'array')
        if (value = attributes[:'array']).is_a?(Array)
          self.array = value
        end
      end

      if attributes.has_key?(:'collectionType')
        self.collection_type = attributes[:'collectionType']
      end
    ...
    def hash
      [array, collection_type, item_type, map, name, required, string, title, tooltip].hash
    end
