...
module ArgoCD
  ...
  class V1alpha1ApplicationSetNestedGenerator
    attr_accessor :cluster_decision_resource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clusterDecisionResource')
        self.cluster_decision_resource = attributes[:'clusterDecisionResource']
      end
      ...
      if attributes.has_key?(:'matrix')
        self.matrix = attributes[:'matrix']
      end
      ...
      if attributes.has_key?(:'scmProvider')
        self.scm_provider = attributes[:'scmProvider']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cluster_decision_resource == o.cluster_decision_resource &&
          clusters == o.clusters &&
          git == o.git &&
          list == o.list &&
          matrix == o.matrix &&
    ...
    def hash
      [cluster_decision_resource, clusters, git, list, matrix, merge, pull_request, scm_provider, selector].hash
    end
