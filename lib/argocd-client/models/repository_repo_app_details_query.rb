...
module ArgoCD
  class RepositoryRepoAppDetailsQuery
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appProject')
        self.app_project = attributes[:'appProject']
      end
    ...
    def hash
      [app_name, app_project, source].hash
    end
