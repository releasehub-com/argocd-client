...
module ArgoCD
  ...
  class V1alpha1PullRequestGeneratorGitLab
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pullRequestState')
        self.pull_request_state = attributes[:'pullRequestState']
      end
    ...
    def hash
      [api, labels, project, pull_request_state, token_ref].hash
    end
