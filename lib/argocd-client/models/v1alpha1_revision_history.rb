...
module ArgoCD
  class V1alpha1RevisionHistory
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deployStartedAt')
        self.deploy_started_at = attributes[:'deployStartedAt']
      end

      if attributes.has_key?(:'deployedAt')
        self.deployed_at = attributes[:'deployedAt']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          deploy_started_at == o.deploy_started_at &&
    ...
    def hash
      [deploy_started_at, deployed_at, id, revision, revisions, source, sources].hash
    end
