  ...
  class V1alpha1ApplicationSpec
    ...
    def self.swagger_types
      {
        ...
        :'ignore_differences' => :'Array<V1alpha1ResourceIgnoreDifferences>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ignoreDifferences')
        if (value = attributes[:'ignoreDifferences']).is_a?(Array)
          self.ignore_differences = value
        end
      end
      ...
      if attributes.has_key?(:'syncPolicy')
        self.sync_policy = attributes[:'syncPolicy']
      end
    end
    ...
    def hash
      [destination, ignore_differences, info, project, revision_history_limit, source, sources, sync_policy].hash
    end
