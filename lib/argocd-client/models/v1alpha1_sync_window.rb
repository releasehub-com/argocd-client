...
module ArgoCD
  class V1alpha1SyncWindow
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'manualSync')
        self.manual_sync = attributes[:'manualSync']
      end
    ...
    def hash
      [applications, clusters, duration, kind, manual_sync, namespaces, schedule, time_zone].hash
    end
