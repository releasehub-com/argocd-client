...
module ArgoCD
  ...
  class V1alpha1MergeGenerator
    attr_accessor :generators

    attr_accessor :merge_keys
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mergeKeys')
        if (value = attributes[:'mergeKeys']).is_a?(Array)
          self.merge_keys = value
        end
      end
    ...
    def hash
      [generators, merge_keys, template].hash
    end
