...
module ArgoCD
  class V1alpha1ExecProviderConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'installHint')
        self.install_hint = attributes[:'installHint']
      end
    end
    ...
    def hash
      [api_version, args, command, env, install_hint].hash
    end
