...
module ArgoCD
  class RepositoryManifestResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'verifyResult')
        self.verify_result = attributes[:'verifyResult']
      end
    end
    ...
    def hash
      [manifests, namespace, revision, server, source_type, verify_result].hash
    end
