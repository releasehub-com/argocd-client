...
module ArgoCD
  class V1alpha1OperationState
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'syncResult')
        self.sync_result = attributes[:'syncResult']
      end
    end
    ...
    def hash
      [finished_at, message, operation, phase, retry_count, started_at, sync_result].hash
    end
