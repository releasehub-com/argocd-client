...
module ArgoCD
  class ProjectDetailedProjectsResponse
    attr_accessor :clusters

    attr_accessor :global_projects
    ...
    def self.swagger_types
      {
        ...
        :'global_projects' => :'Array<V1alpha1AppProject>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'globalProjects')
        if (value = attributes[:'globalProjects']).is_a?(Array)
          self.global_projects = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          clusters == o.clusters &&
          global_projects == o.global_projects &&
          project == o.project &&
    ...
    def hash
      [clusters, global_projects, project, repositories].hash
    end
