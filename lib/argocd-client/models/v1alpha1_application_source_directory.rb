...
module ArgoCD
  class V1alpha1ApplicationSourceDirectory
    attr_accessor :exclude

    attr_accessor :include

    attr_accessor :jsonnet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'jsonnet')
        self.jsonnet = attributes[:'jsonnet']
      end

      if attributes.has_key?(:'recurse')
    ...
    def hash
      [exclude, include, jsonnet, recurse].hash
    end
